...
export const FeedEntryScalarFieldEnumSchema = z.enum(['id','guid','title','link','content','contentSnippet','language','author','ingested','published','categories','feedId','userId','createdAt','updatedAt']);
