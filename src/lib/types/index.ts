...
export const BookmarkScalarFieldEnumSchema = z.enum(['id','title','url','image','imageBlur','desc','categoryId','metadata','userId','createdAt','updatedAt']);
...
export const FeedScalarFieldEnumSchema = z.enum(['id','name','url','userId','lastFetched','createdAt','updatedAt']);

export const FeedEntryScalarFieldEnumSchema = z.enum(['id','title','link','description','language','author','ingested','feedId','userId','createdAt','updatedAt']);

export const FeedEntryMediaScalarFieldEnumSchema = z.enum(['id','href','title','medium','height','width','feedEntryId','userId','createdAt','updatedAt']);
...
export const FeedEntryOrderByWithRelationInputSchema: z.ZodType<Prisma.FeedEntryOrderByWithRelationInput> = z.object({
  id: z.lazy(() => SortOrderSchema).optional(),
...
export const TagsOnBookmarksFindFirstArgsSchema: z.ZodType<Prisma.TagsOnBookmarksFindFirstArgs> = z.object({
  ...
  orderBy: z.union([ TagsOnBookmarksOrderByWithRelationInputSchema.array(),TagsOnBookmarksOrderByWithRelationInputSchema ]).optional(),
...
export const FeedEntryFindFirstArgsSchema: z.ZodType<Prisma.FeedEntryFindFirstArgs> = z.object({
  ...
  orderBy: z.union([ FeedEntryOrderByWithRelationInputSchema.array(),FeedEntryOrderByWithRelationInputSchema ]).optional(),
...
export const FeedEntryMediaFindFirstArgsSchema: z.ZodType<Prisma.FeedEntryMediaFindFirstArgs> = z.object({
  ...
  orderBy: z.union([ FeedEntryMediaOrderByWithRelationInputSchema.array(),FeedEntryMediaOrderByWithRelationInputSchema ]).optional(),
