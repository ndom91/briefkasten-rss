...
export const FeedEntryScalarFieldEnumSchema = z.enum(['id','guid','title','link','content','contentSnippet','author','ingested','published','categories','feedId','userId','createdAt','updatedAt']);
